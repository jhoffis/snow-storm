...
//FORSØK PÅ SKYBOX - Må jobbes litt mer med. Også endre bildene til noe mer passende
    ...
    let materialArray = [];
    let texture_ft = new THREE.TextureLoader().load( 'res/textures/iceflats_ft.png');
    let texture_bk = new THREE.TextureLoader().load( 'res/textures/iceflats_bk.png');
    let texture_up = new THREE.TextureLoader().load( 'res/textures/iceflats_up.png');
    let texture_dn = new THREE.TextureLoader().load( 'res/textures/iceflats_dn.png');
    let texture_rt = new THREE.TextureLoader().load( 'res/textures/iceflats_rt.png');
    let texture_lf = new THREE.TextureLoader().load( 'res/textures/iceflats_lf.png');
