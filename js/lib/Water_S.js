...
class Water_S extends THREE.Mesh {
    constructor(geometry, options) {
        ...
        var normalMap0 = options.normalMap0 || textureLoader.load('res/textures/Water_1_M_Normal.jpg');
        var normalMap1 = options.normalMap1 || textureLoader.load('res/textures/Water_2_M_Normal.jpg');
